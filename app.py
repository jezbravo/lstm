...
# DATASET
dataset = pd.read_csv('microsoft_stocks.csv', index_col='Date', parse_dates=['Date'])
...
training_set = dataset[:'2020'].iloc[:,0:1]
validation_set = dataset['2021':].iloc[:,0:1]
...
plt.legend(['Training (2015-2020)', 'Validation (2021 - )'])
plt.show()
